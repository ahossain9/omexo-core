...
class Floating_Effects {
	...
	public static function enqueue_scripts() {
		...
		wp_enqueue_script(
			'anime',
			OMEXER_INSIGHT_ASSETS . 'js/anime.min.js',
			null,
			OMEXER_INSIGHT_VERSION,
			true
		);

		$extension_js = OMEXER_INSIGHT_DIR_PATH . 'assets/js/extension-floating-effects.min.js';
	...
	public static function register( Element_Base $element ) {
		$element->start_controls_section(
			...
			[
				'label' => __( 'Floating Effects', 'omexer-insight' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Translate', 'omexer-insight' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Translate X', 'omexer-insight' ),
				...
				'labels' => [
					__( 'From', 'omexer-insight' ),
					__( 'To', 'omexer-insight' ),
				],
				'scales' => 1,
				'handles' => 'range',
				'condition' => [
		...
		$element->add_control(
			...
			[
				'label' => __( 'Translate Y', 'omexer-insight' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'from' => 0,
		...
		$element->add_control(
			...
			[
				'label' => __( 'Rotate X', 'omexer-insight' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'from' => 0,
		...
		$element->add_control(
			...
			[
				'label' => __( 'Rotate Y', 'omexer-insight' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'from' => 0,
		...
		$element->add_control(
			...
			[
				'label' => __( 'Scale X', 'omexer-insight' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'from' => 1,
		...
		$element->add_control(
			...
			[
				'label' => __( 'Scale Y', 'omexer-insight' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'from' => 1,
