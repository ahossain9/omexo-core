        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'bounceInRight'     => __( 'Bounce In Right','omexer-insight' ),
                    'bounceInUp'        => __( 'Bounce In Up','omexer-insight' ),
                    'slideIn'           => __( 'Slider In','omexer-insight' ),
                    'slideInDown'       => __( 'Slider In Down','omexer-insight' ),
                    'slideInLeft'       => __( 'Slider In Left','omexer-insight' ),
                    'slideInRight'      => __( 'Slider In Right','omexer-insight' ),
                    'slideInUp'         => __( 'Slider In Up','omexer-insight' ),
                    ...
                    'rotateInUpLeft'    => __( 'Rotate In Down Left','omexer-insight' ),
                    'rotateInUpRight'   => __( 'Rotate In Down Right','omexer-insight' ),
