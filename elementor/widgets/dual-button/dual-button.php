...
class Dual_Button extends Widget_Base {
    ...
    public function get_name() {
        return 'omexer-dual-button';
    }

    public function get_title() {
        return esc_html__( 'Dual Button', 'omexer-insight' );
    }

    public function get_icon() {
        return 'omexer-insight-icon eicon-dual-button';
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            '_section_button',
            [
                'label' => __( 'Dual Buttons', 'omexer-insight' ),
        ...
        $this->start_controls_tab(
            'tab_button_primary',
            [
                'label' => __( 'Primary', 'omexer-insight' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'before' => [
                        'title' => __( 'Before', 'omexer-insight' ),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'after' => [
                        'title' => __( 'After', 'omexer-insight' ),
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __( 'Secondary', 'omexer-insight' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    'horizontal' => [
                        'title' => __( 'Horizontal', 'omexer-insight' ),
                        'icon' => 'eicon-navigation-horizontal',
                    ],
                    'vertical' => [
                        'title' => __( 'Vertical', 'omexer-insight' ),
		...
		$this->add_responsive_control(
            'button_gap',
            [
                'label' => __( 'Space Between Buttons', 'omexer-insight' ),
		...
		$this->start_controls_section(
			'left_button_style',
            [
                'label' => __( 'Primary Button', 'omexer-insight' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Secondary Button', 'omexer-insight' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
