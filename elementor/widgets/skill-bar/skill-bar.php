<?php
/**
 * omexer_insight skill bar widget for elementor
...
class Skill_Bar extends Widget_Base {
    ...
    public function get_name() {
        return 'omexer-skill-bar';
    }
    
    public function get_title() {
        return __( 'Skill Bar', 'omexer-insight' );
    }

    public function get_icon() {
        return 'omexer-insight-icon eicon-skill-bar';
    }
	...
	protected function register_controls() {
        $this->start_controls_section(
            '_section_skills',
            [
                'label' => __( 'Skills', 'omexer-insight' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Design', 'omexer-insight' ),
                'placeholder' => __( 'Type a skill name', 'omexer-insight' ),
            ]
        );
        ...
        $repeater->add_control(
            'level',
            [
                'label' => __( 'Level (Out Of 100)', 'omexer-insight' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'return_value' => 'yes',
                'description' => __( 'You can customize this skill bar color from here or customize from Style tab', 'omexer-insight' ),
                'style_transfer' => true,
            ]
        );
        ...
        $repeater->add_control(
            'level_color',
            [
                'label' => __( 'Level Color', 'omexer-insight' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater->add_control(
            'base_color',
            [
                'label' => __( 'Base Color', 'omexer-insight' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => __( 'Text Position', 'omexer-insight' ),
                'separator' => 'before',
                'default' => 'inside',
                'options' => [
                    'inside' => __( 'Text Inside', 'omexer-insight' ),
                    'outside' => __( 'Text Outside', 'omexer-insight' ),
                ],
                'style_transfer' => true,
            ]
        );
        ...
        $this->start_controls_section(
            '_section_style_bars',
            [
                'label' => __( 'Skill Bars', 'omexer-insight' ),
