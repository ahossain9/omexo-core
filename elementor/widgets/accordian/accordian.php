<?php
/**
 * omexer_insight accordian widget for elementor
...
class Accordian extends Widget_Base {
    ...
    public function get_name() {
        return 'omexer-accordian';
    }
    
    public function get_title() {
        return __( 'Accordian', 'omexer-insight' );
    }

    public function get_icon() {
        return 'omexer-insight-icon eicon-accordion';
    }
	...
	protected function _register_controls() {
        $this->start_controls_section(
            '_section_accordian',
            [
                'label' => __( 'Accordian', 'omexer-insight' ),
        ...
        $accordion_lists->add_control(
            ...
            [
                ...
                'default' => __('Title', 'omexer-insight'),
                'label_block' => true,
            ]
        );
        ...
        $accordion_lists->add_control(
            ...
            [
                ...
                'default' => __('Accordion description text', 'omexer-insight')
            ]
        );
        ...
        $accordion_lists->add_control(
            'status',
            [
                'label' => __('Is Active?', 'omexer-insight'),
        ...
        $this->add_control(
            'accordion_lists',
            [
                'label' => __('Accordion Box', 'omexer-insight'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $accordion_lists->get_controls(),
                'default' => [
                    [
                        'title' => __('My Progress', 'omexer-insight'),
                        'text' => __('Accordion Paragraph text', 'omexer-insight'),
                        'status' => 'no'
                    ],
                ],
                'title_field' => '{{{ title }}}',
		...
		$this->add_control(
			'icon_active_color',
			[
				'label' => __( 'Active Color', 'omexer-insight' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
