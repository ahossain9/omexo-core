<?php
/**
 * omexer_insight course carousel widget for elementor
...
class Course_Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'omexer-course-carousel';
    }
    
    public function get_title() {
        return __( 'Course Carousel', 'omexer-insight' );
    }

    public function get_icon() {
        return 'omexer-insight-icon eicon-slider-full-screen';
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'carousel_items',
            [
                'label'   => esc_html__( 'Number of Items', 'omexer-insight' ),
        ...
        $this->add_control(
            'carousel_arrows',
            [
                'label'        => esc_html__( 'Navigation Arrow', 'omexer-insight' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'default'      => 'no'
            ]
        ...
        $this->add_control(
            'carousel_dots',
            [
                'label' => esc_html__( 'Navigation Dots', 'omexer-insight' ),
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'default' => 'yes'
            ]
        ...
        $this->add_control(
            'carousel_autolay',
            [
                'label'        => esc_html__( 'Autoplay', 'omexer-insight' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'default'      => 'no',
            ]
        ...
        $this->add_control(
            ...
            [
                'label'   => __( 'Number of Items', 'omexer-insight' ),
                'type'    => Controls_Manager::NUMBER,
                'min'     => 1,
                'max'     => 3,
                'step'    => 1,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Navigation Arrow', 'omexer-insight' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'carousel_arrows'  => 'yes'
                ]
        ...
        $this->add_responsive_control(
            'left_arrow_postion',
            [
                'label' => __( 'Left Arrow Position', 'omexer-insight' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'right_arrow_postion',
            [
                'label' => __( 'Right Arrow Position', 'omexer-insight' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'arrow_line_height',
            [
                'label' => __( 'Line Height', 'omexer-insight' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px'],
                'range' => [
                    'px' => [
