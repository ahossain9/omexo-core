...
class Omexer_Insight_Contact_Widget extends WP_Widget{
    public function __construct(){

        parent::__construct('Omexer_Insight_Contact_Widget', esc_html__('Contact Us', 'omexer-insight'), array(
            'description'   =>  esc_html__('Contact us information', 'omexer-insight'),
        ));
    }
        ...
        if(!empty($instance['email_address'])){ ?>
            ...
            if(!empty($instance['footer_mobile'])){ ?>
                <li class="footer-mobile-number">
                    <p><i class="fa fa-phone-alt" aria-hidden="true"></i><?php echo esc_html($instance['footer_mobile']);?></p>
                </li>
    ...
    public function form($instance){
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('address_desc'));?>"> <?php echo esc_html__( 'Location', 'omexer-insight' );?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title'));?>"> <?php echo esc_html__( 'Email', 'omexer-insight' );?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('footer_mobile'));?>"> <?php echo esc_html__( 'Mobile Number', 'omexer-insight' );?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('footer_subscribe'));?>"> <?php echo esc_html__( 'Subscribe Form Shortcode ', 'omexer-insight' );?></label>
...
if ( ! function_exists( 'Omexer_Insight_Contact_Widget_init' ) ) {
	function Omexer_Insight_Contact_Widget_init() {
		register_widget('Omexer_Insight_Contact_Widget');
	}

	add_action('widgets_init', 'Omexer_Insight_Contact_Widget_init');
}